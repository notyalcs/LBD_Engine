...
constexpr float HORIZONTAL_MOVEMENT_SPEED{ 30.0f };
constexpr float VERTICAL_MOVEMENT_SPEED{ 30.0f };
constexpr DirectX::XMFLOAT3 INITIAL_CAMERA_POSITION{ 0.0f, 10.0f, 100.0f };
